Rodando Script power DNS inpec:
                                    ...
                                    |_      _|   | .__/| (//) |\ V  V /|  __/| |     | |_/ || || | | |\__ \   | .__/|  ___/| (__     |_|
                                      |_||_|     |_|    \//__/  \_/\_/  \___||_|     |____/ |_||_| |_||___/   |_|    \____| \___|
                                                        //               | |                (_)        |_|                           (_)           2.3.3v
                                                              ...
                                                              === Starting all checks for URL: https://juice-shop.herokuapp.com/#/ ===



                                                                                 Scan Selected's:

                                                                            1. HTTP Status Code       [1]
                                                                            2. Page Title             [1]
                                                                            3. IP Address from DNS    [1]
                                                                            4. Allowed HTTP Methods   [1]
                                                                            5. Server Headers         [1]
                                                                            6. Technologies in Use    [1]
                                                                            7. Security Headers Check [1]
                                                                            8. DNS Zone Transfer Test [1]
                                                                            9. Check DNS Records      [1]
                                                                           10. Links in HTML          [1]
                                                                           11. Robots.txt             [1]
                                                                           12. Sitemap.xml            [1]
                                                                           13. Port Banner Grabbing   [1]
                                                                           14. Words for Fuzzing      [1]


               Auto Fuzzing Mode: DISABLED

               tip: You can configure the scans in the configuration Sub-Menu - Option [0] .
...
=== 3. IP Address from DNS ===

 Searching for IP's DNS ...
...
=== 4. Allowed HTTP Methods ===
 ...
 Checking supported HTTP methods...

HTTP Methods Analysis:
  No Allow header found in response.
...
=== 6. Technologies in Use ===
 ...
 Detecting technologies in use...

Detected Technologies:
  JavaScript: jQuery

  Total technologies found: 1
...
=== 7. Security Headers Check ===
 ...
 Checking Security Headers...
  ...
  [MISSING] X-Permitted-Cross-Domain-Policies
    Importance: Low
    Purpose: Flash cross-domain policy

  Security Headers Score: 25%
  Found: 2/8 security headers

  Critical headers missing: Strict-Transport-Security, Content-Security-Policy


=== 8. DNS Zone Transfer Test ===

  Testing DNS Zone Transfer for: juice-shop.herokuapp.com ...
  No NS records found


=== 9. Check DNS Records ===

 Checking DNS records for: juice-shop.herokuapp.com
 ...
 Records found:
   ...
   SOA Record:
     Primary Server: dns1.p03.nsone.net
   ...
   Reverse Lookup (PTR):
     IPv4: 46.137.15.86 -> ec2-46-137-15-86.eu-west-1.compute.amazonaws.com
     IPv4: 54.73.53.134 -> ec2-54-73-53-134.eu-west-1.compute.amazonaws.com
     IPv4: 54.220.192.176 -> ec2-54-220-192-176.eu-west-1.compute.amazonaws.com
     IPv6:  -> PTR not found
...
USER AGENTS: No specific user agents defined (applies to all crawlers)

DISALLOWED PATHS: None found (all paths are accessible to crawlers)
...
<style>html{--mat-sys-on-surface:initial}.mat-app-background{background-color:var(--mat-app-background-color, var(--mat-sys-background, transparent));color:var(--mat-app-text-color, var(--mat-sys-on-background, inherit))}.mat-typography{font:400 14px/20px Roboto,sans-serif;letter-spacing:.0178571429em}html{--mat-tooltip-supporting-text-font:Roboto, sans-serif;--mat-tooltip-supporting-text-size:12px;--mat-tooltip-supporting-text-weight:400;--mat-tooltip-supporting-text-tracking:.0333333333em}html{--mat-app-background-color:#fafafa;--mat-app-tex

... (content truncated - too large)

FILE INFORMATION:
  Content Length: 75001 characters
  Approx. Size: 73.24 KB
  Lines: 32
  User Agents: 0
  Disallowed Paths: 0
  Allowed Paths: 0
...
=== 13. Port Banner Grabbing ===
 ...
 Checking Port Banner's ...

    Scanning ports:
 [ 21, 22, 80, 443, 3306, 5432, 8080 ]

 Estimated time for port scan: 0.2 minutes

    Testing web service on port 80...
[juice-shop.herokuapp.com:80] HTTP Banner: HTTP/1.1 200 OK | Server: Heroku
[juice-shop.herokuapp.com:5432] Timeout - No Connection
[juice-shop.herokuapp.com:22] Timeout - No Connection

    Testing web service on port 8080...
[juice-shop.herokuapp.com:8080] No HTTP banner received
[juice-shop.herokuapp.com:3306] Timeout - No Connection

    Testing web service on port 443...
[juice-shop.herokuapp.com:443] HTTP Banner: HTTP/1.1 200 OK | Server: Heroku
[juice-shop.herokuapp.com:21] Timeout - No Connection


=== 14. Words for Fuzzing ===
Executing Words for Fuzzing (this will be used for Auto Fuzzing if enabled)...

 Obtaining words from the HTML source code...

Total unique words found: 1001

Example of found words (first 15):
   0000
   0178571429em
   0279069767
   0297674419
...
Do you want to save the words to a file for fuzzing? (Y/N): y

Created directory: Fuzz_files

Words saved to: Fuzz_files\wordlist_juice-shop_herokuapp_com_20251112_211210.txt
Total words: 1001
